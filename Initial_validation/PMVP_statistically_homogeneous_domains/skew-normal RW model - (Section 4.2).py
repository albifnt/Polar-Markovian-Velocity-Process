# SCRIPT: skew-normal RW model - (Section 4.2)
...
# FIRST: DETERMINATION OF THE PROBABILITY DISTRIBUTION TO EXTRACT INTIAL VALUES OF theta AND v
...
#np.savetxt('Variance_x_18.txt', variance, delimiter=',')
...
#plt.plot(t_prime, variance)
#np.savetxt('Variance_y_18.txt', variance, delimiter=',')
